'''
Multiple infection waves as trajectory ensemble being a result of the city closedown and reopen interventions pendulum.
Social distancing compliance sampled randomly.
'''
...
if te.is_db_empty:
    ...
    te.add_trajectories([
        ...
        # ) for sdc in TN(0.0, 1.0, 0.5, 0.15, 10)
        ) for sdc in TN(0.0, 1.0, 0.5, 0.15, 4)
    ])
...
if do_plot and not te.is_db_empty:
    series = [{ 'var': 'p_E', 'lbl': 'E' }, { 'var':f'p_I', 'lbl': 'I' }, { 'var':f'p_X', 'lbl': 'X' }]
