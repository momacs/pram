'''
No interventions that result in a full population (i.e., single-wave) susceptile-to-recovered conversion.  Notable is
an inflection point that plateaus the epidemic for a little bit before it picks up again.
...
sim = (Simulation(pop_hist_len=0).
    ...
    add([
        ...
        # DiseaseRule('school', r0=1.8, p_E_IA=0.40, p_IA_IS=0.40, p_IS_R=0.40, p_home_E=0.0, p_social_E=0.95, soc_dist_comp_young=0.66, soc_dist_comp_old=0.45, p_fat_by_age_group=p_covid19_fat_by_age_group_comb),
        # DiseaseRule('work',   r0=1.8, p_E_IA=0.40, p_IA_IS=0.40, p_IS_R=0.40, p_home_E=0.0, p_social_E=0.95, soc_dist_comp_young=0.66, soc_dist_comp_old=0.45, p_fat_by_age_group=p_covid19_fat_by_age_group_comb),
