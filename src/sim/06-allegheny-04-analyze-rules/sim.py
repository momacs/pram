...
fpath_sites  = os.path.join(os.path.dirname(__file__), 'fred-flu-sites.pickle.gz')
fpath_groups = os.path.join(os.path.dirname(__file__), 'fred-flu-groups.pickle.gz')
